...
#                 vendor: Linux 4.10.0-40-generic xhci-hcd
#                 physical id: 0
#                 bus info: usb@2
#                 logical name: usb2
#                 version: 4.10
...
#                 configuration: broadcast=yes driver=ath9k driverversion=4.10.0-40-generic firmware=N/A ip=192.168.0.20 latency=0 link=yes multicast=yes wireless=IEEE 802.11
...
#                 resources: irq:46 memory:f2000000-f2ffffff memory:e0000000-efffffff memory:f0000000-f1ffffff ioport:3000(size=128)
#         *-usb:1
#              description: USB controller
...
#                 vendor: Linux 4.10.0-40-generic ehci_hcd
#                 physical id: 1
#                 bus info: usb@1
#                 logical name: usb1
#                 version: 4.10
...
#              version: 0001
#              serial: S30YJ9HDB00344
#              size: 931GiB (1TB)
#              capabilities: partitioned partitioned:dos
#              configuration: ansiversion=5 logicalsectorsize=512 sectorsize=4096 signature=11c66eec
#            *-volume:0
...
#                 logical name: /
#                 version: 1.0
#                 serial: 5858a643-91d4-48aa-9c25-e1ae9553dfeb
#                 size: 927GiB
#                 capacity: 927GiB
#                 capabilities: primary bootable journaled extended_attributes large_files huge_files dir_nlink extents ext4 ext2 initialized
#                 configuration: created=2017-11-29 08:57:31 filesystem=ext4 lastmountpoint=/ modified=2018-01-24 17:07:03 mount.fstype=ext4 mount.options=rw,relatime,errors=remount-ro,data=ordered mounted=2018-01-24 14:56:36 state=mounted
#            *-volume:1
